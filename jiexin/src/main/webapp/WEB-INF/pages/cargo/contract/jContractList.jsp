...
<li id="delete"><a href="#" onclick="formSubmit('deletebatch','_self');this.blur();">删除</a></li>
	<li id="submit"><a href="#" onclick="formSubmit('submit','_self');this.blur();">上报</a></li>
	<li id="delete"><a href="#" onclick="formSubmit('cancel','_self');this.blur();">取消</a></li>
<li id="print"><a href="#" onclick="formSubmit('print','_self');this.blur();">打印</a></li>
	<li id="new"><a href="#" onclick="formSubmit('pigeonhole','_self');this.blur();">归档</a></li>
</ul>
  </div>
</div>
</div>
...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>${o.customName}</td>
		<td><a href="toview?contractId=${o.contractId}">${o.contractNo}</a></td>
