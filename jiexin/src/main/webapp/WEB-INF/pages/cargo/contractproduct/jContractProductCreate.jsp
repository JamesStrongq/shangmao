...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('insert','_self');">确定</a></li>
<li id="back"><a href="${ctx}/cargo/contract/list">返回</a></li>
</ul>
    </div>
</div>
</div>
...
<div>
	...
	<table id="ec_table" class="tableRegion" width="98%" >
		...
		<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
			...
			<td>${o.amount}</td>
			<td>
				<a href="toupdate?contractProductId=${o.contractProductId}">[修改]</a>
				<a href="delete?contractProductId=${o.contractProductId}&contractId=${o.contractId}">[删除]</a>
				<a href="${ctx}/cargo/extcproduct/tocreate?contractProductId=${o.contractProductId}">[附件]</a>
			</td>
		</tr>
		</c:forEach>
