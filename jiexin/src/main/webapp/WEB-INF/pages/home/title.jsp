...
onclick="top.location.href='fmain';linkHighlightMenu(this);">系统首页</span><span id="tm_separator"></span><span id="topmenu"
onclick="top.leftFrame.location.href='cargoLeft';top.main.location.href='cargoMain';linkHighlightMenu(this);">货运管理</span><span id="tm_separator"></span><span id="topmenu"
onclick="top.leftFrame.location.href='baseinfoLeft';top.main.location.href='baseinfoMain';linkHighlightMenu(this);">基础信息</span><span id="tm_separator"></span><span id="topmenu"
