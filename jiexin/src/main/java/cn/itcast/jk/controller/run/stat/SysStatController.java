...
public class SysStatController {
    ...
    //生产厂家销售情况统计饼形图
    @RequestMapping("/run/stat/factorySale")
    public ModelAndView factorySale(HttpServletRequest request) throws FileNotFoundException{
        ...
        modelAndView.addObject("forward","factorysale");
        modelAndView.setViewName("run/stat/jState");
        return modelAndView;			//通过统一的jsp跳转，转向指定目录下的index.html
    }

    //产品销售排行柱状图
    @RequestMapping("/run/stat/productSale")
    public ModelAndView productSale(HttpServletRequest request) throws FileNotFoundException{
        ...
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("forward","productsale");
        modelAndView.setViewName("run/stat/jState");
        return modelAndView;
    }

    //系统访问压力曲线图
    @RequestMapping("/run/stat/onlineInfo")
    public ModelAndView onlineInfo(HttpServletRequest request) throws FileNotFoundException{
        ...
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("forward","onlineinfo");
        modelAndView.setViewName("run/stat/jState");
        return modelAndView;
    }
